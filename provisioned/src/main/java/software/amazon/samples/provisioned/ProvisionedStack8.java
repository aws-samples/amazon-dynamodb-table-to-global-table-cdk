...
public class ProvisionedStack8 extends Stack {

  public ProvisionedStack8(final Construct parent, final String id) {
    this(parent, id, null);
  }

  public ProvisionedStack8(final Construct parent, final String id, final StackProps props) {
  ...
  private CfnGlobalTable createGlobalTable() {
    ...
    List<CfnGlobalTable.GlobalSecondaryIndexProperty> indexes = List.of(
