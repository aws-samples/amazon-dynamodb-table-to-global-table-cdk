...
public class ProvisionedStack4 extends Stack {

  public ProvisionedStack4(final Construct parent, final String id) {
    this(parent, id, null);
  }

  public ProvisionedStack4(final Construct parent, final String id, final StackProps props) {
