...
public class ProvisionedStack2 extends Stack {

  public ProvisionedStack2(final Construct parent, final String id) {
    this(parent, id, null);
  }

  public ProvisionedStack2(final Construct parent, final String id, final StackProps props) {
