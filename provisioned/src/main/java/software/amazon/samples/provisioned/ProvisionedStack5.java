...
public class ProvisionedStack5 extends Stack {

  public ProvisionedStack5(final Construct parent, final String id) {
    this(parent, id, null);
  }

  public ProvisionedStack5(final Construct parent, final String id, final StackProps props) {
