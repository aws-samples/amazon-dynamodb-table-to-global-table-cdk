...
public class ProvisionedStack1 extends Stack {

  public ProvisionedStack1(final Construct parent, final String id) {
    this(parent, id, null);
  }

  public ProvisionedStack1(final Construct parent, final String id, final StackProps props) {
