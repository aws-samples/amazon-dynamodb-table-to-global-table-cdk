...
public class ProvisionedStack6 extends Stack {

  public ProvisionedStack6(final Construct parent, final String id) {
    this(parent, id, null);
  }

  public ProvisionedStack6(final Construct parent, final String id, final StackProps props) {
  ...
  // Using CfnGlobalTable instead of ITable
