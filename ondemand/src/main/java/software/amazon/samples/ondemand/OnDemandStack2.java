...
public class OnDemandStack2 extends Stack {

  public OnDemandStack2(final Construct parent, final String id) {
    this(parent, id, null);
  }

  public OnDemandStack2(final Construct parent, final String id, final StackProps props) {
