...
public class OnDemandStack3 extends Stack {

  public OnDemandStack3(final Construct parent, final String id) {
    this(parent, id, null);
  }

  public OnDemandStack3(final Construct parent, final String id, final StackProps props) {
