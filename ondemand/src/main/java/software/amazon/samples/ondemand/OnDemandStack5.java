...
public class OnDemandStack5 extends Stack {

  public OnDemandStack5(final Construct parent, final String id) {
    this(parent, id, null);
  }

  public OnDemandStack5(final Construct parent, final String id, final StackProps props) {
